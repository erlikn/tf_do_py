...
imageColorRows_desc = "Depth Image Height (ROWS)"
imageColorCols_desc = "Depth Image Width (COLS)"
imageColorChannels_desc = "Depth Image channels, number of stacked images"
# PCL Parameters
...
data = {
    ...
    'imageColorRows' : 185,
    'imageColorCols' : 613,
    'imageColorChannels' : 3, # All Colors files should have same cols
    # PCL Parameters
    'pclRows' : 3,
    'pclCols' : 62074,
    # tMat Parameters
...
def write_iterative(runName, itrNum, dataLocal):
    ...
    elif runName == '180521_170706': # using 170706_ITR_B but with loss for all n-1 tuples
        data['classificationModel'] = {'Model' : True, 'binSize' : 32}
        itr_180521_170706_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, runName, itrNum, dataLocal)
    elif runName == '180522_170706': # using 170706_ITR_B but with loss for all n-1 tuples
        itr_180522_170706_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, runName, itrNum, dataLocal)
    elif runName == '180523_170706': # using 170706_ITR_B but with loss for all n-1 tuples
    ...
    elif runName == '180926': # using 170706_ITR_B but with loss for all n-1 tuples
        itr_180926_incep_lstm(reCompileITR, trainLogDirBase, testLogDirBase, runName, itrNum, dataLocal)
    else:
...
def itr_180521_170706_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, runName, itrNum, data):
    if reCompileITR:
        runPrefix = runName+'_'
        data['modelName'] = 'twin_cnn_4p4l2f_inception'
        data['numParallelModules'] = 2
        ...
        data['lossFunction'] = "Weighted_Params_L2_loss_nTuple" #Weighted_L2_loss #_params_transformation_loss_nTuple_last
        data['numTuple'] = 2
        ### ITERATION 1
        if itrNum == 1:
            runName = runPrefix+str(itrNum)
            data['trainDataDir'] = '../Data/kitti/train_64h_reg_2_tpl_6_prm'
            data['testDataDir'] = '../Data/kitti/test_64h_reg_2_tpl_6_prm'
            data['trainLogDir'] = trainLogDirBase + runName
            data['testLogDir'] = testLogDirBase + runName
            data['warpedTrainDataDir'] = warpedTrainDirBase + runName
            data['warpedTestDataDir'] = warpedTestDirBase+ runName
...
def itr_180522_170706_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, runName, itrNum, data):
    if reCompileITR:
        runPrefix = runName+'_'
        data['modelName'] = 'twin_cnn_4p4l2f_inception'
        data['numParallelModules'] = 2
        ...
        data['optimizer'] = 'MomentumOptimizer' # AdamOptimizer MomentumOptimizer GradientDescentOptimizer
        data['modelShape'] = [32, 64, 32, 64, 64, 128, 64, 128, 1024]
        data['trainBatchSize'] = 24
        data['testBatchSize'] = 24
        data['numTrainDatasetExamples'] = 20400
        data['numTestDatasetExamples'] = 2790
        data['outputSize'] = 12
        data['logicalOutputSize'] = 12
        data['lossFunction'] = "weighted_L2_loss_nTuple" #Weighted_L2_loss
        data['numTuple'] = 2
        ### ITERATION 1
        if itrNum == 1:
            runName = runPrefix+str(itrNum)
            data['trainDataDir'] = '../Data/kitti/train_64h_reg_2_tpl_12_prm'
            data['testDataDir'] = '../Data/kitti/test_64h_reg_2_tpl_12_prm'
            data['trainLogDir'] = trainLogDirBase + runName
            data['testLogDir'] = testLogDirBase + runName
            data['warpedTrainDataDir'] = warpedTrainDirBase + runName
            data['warpedTestDataDir'] = warpedTestDirBase+ runName
...
def itr_180523_170706_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, runName, itrNum, data):
    if reCompileITR:
        runPrefix = runName+'_'
        data['modelName'] = 'twin_cnn_4p4l2f_inception'
        data['numParallelModules'] = 2
...
def itr_180527_170706_ITR_B_inception(reCompileITR, trainLogDirBase, testLogDirBase, runName, itrNum, data):
    if reCompileITR:
        runPrefix = runName+'_'
        data['modelName'] = 'twin_cnn_4p4l2f_inception_receptive'
        data['numParallelModules'] = 2
        data['imageDepthChannels'] = 2
        data['optimizer'] = 'MomentumOptimizer' # AdamOptimizer MomentumOptimizer GradientDescentOptimizer
        data['modelShape'] = [32, 64, 32, 64, 64, 128, 64, 128, 1024]
...
def itr_180926_incep_lstm(reCompileITR, trainLogDirBase, testLogDirBase, runName, itrNum, data):
    if reCompileITR:
        runPrefix = runName+'_'
        data['modelName'] = 'nt_4p3l1f1lstm1f'
        data['numParallelModules'] = 5
        data['imageDepthChannels'] = 5
        data['numTuple'] = 5
        data['optimizer'] = 'MomentumOptimizer' # AdamOptimizer MomentumOptimizer GradientDescentOptimizer
        data['modelShape'] = [64, 64, 
                              80, 80,
                              96, 96, 
                              128, 128, 
                              144, 144,
